...
interface ICSVerifier {
    ...
    struct ProcessConsolidationInput {
        ...
        // balance of the validator before consolidation processing Represents the validator's balance before the CL
        // processes the pending consolidation. Used as a proxy for the "withdrawal balance" in accounting/penalties,
        // since consolidation is not an EL withdrawal.
