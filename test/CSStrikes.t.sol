...
contract CSStrikesTest is CSStrikesTestBase {
    ...
    function test_verifyProof() public {
        ...
        stdstore.target(address(strikes)).sig("treeRoot()").checked_write(
            tree.root()
        );
    ...
    function test_verifyProof_RevertWhen_InconsistentData() public {
        uint256 noId = 42;
        (bytes memory pubkey, ) = keysSignatures(1);
        uint256[] memory strikesData = new uint256[](6);
        strikesData[0] = 100500;
    ...
    function test_verifyProof_RevertWhen_EmptyProof() public {
        uint256 noId = 42;
        (bytes memory pubkey, ) = keysSignatures(1);
        uint256[] memory strikesData = new uint256[](6);
        strikesData[0] = 100500;
